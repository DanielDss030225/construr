...
- **JavaScript**: Interatividade básica (se aplicável).
- **Font Awesome**: Ícones para serviços e elementos visuais.
...
├── fundacao01.jpg          # Imagens de projetos
├── fundacao02.jpg
├── fundacao03.jpg
├── fundacao04.jpg
├── fundacao05.jpg
├── fotoDeEngenheiro.png    # Foto do engenheiro
├── icone.png               # Ícone adicional
...
2. **Execução Local**:
   - Abra o arquivo `funda-landing-page/index.html` em um navegador web.
   - Ou use um servidor local:
     ```
     cd funda-landing-page
...
- **Imagens**: Substitua as imagens na pasta raiz para personalizar logos, projetos e foto do engenheiro.
- **Conteúdo**: Edite `index.html` para alterar textos, serviços ou seções.
- **Estilos**: Modifique `styles.css` para ajustar cores, fontes e layout.
- **Scripts**: Atualize `script.js` para adicionar funcionalidades interativas.
...
- **Empresa**: Construr
- **Proprietário**: Joaquim Fernandes
- **WhatsApp**: +55 31 8910-2831
